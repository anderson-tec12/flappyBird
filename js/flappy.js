...
function Passaro(alturaJogo) {
    ...
    this.setY = y => this.elemento.style.bottom = `${y}px` //passando o valor para a altura do passaro

    window.onkeydown = e => voando = true //tecla pressionada
    window.onkeyup = e => voando = false //tecla souta

    this.animar = () => {
        const novoY = this.getY() + (voando ? 8 : -5)
        const alturaMaxima = alturaJogo - this.elemento.clientHeight * 2.4 //altura maxima de voo
...
function estaoSobrePosto(elementoA, elementoB){
    const a = elementoA.getBoundingClientRect() //tamanho do retangulo do elemento
